...
<div class="row mb-3">
    <div class="col-md-6 order-sm-1 order-1 col-6 mt-2" >
        <h1 class="title-responsive">All Users Tasks</h1>
    </div>
                ...
                <tr>
                   ...
                   <td><b class="badge badge-pill badge-red">{{$task->status}}</b></td>
                    ...
                    <td>
                        ...
                        <a href="#" onclick="deleteUserTask({{ $task->id }})" class="badge badge-pill badge-red"><i class="fas fa-trash-alt   br-100"></i></a>
                        <a href="{{ route('view.usertask', ['id' => $task->id]) }}" class="badge badge-pill badge-green"><i class="fas fa-external-link-alt    br-100"></i></a>
...
@if(isset($task->id))
<form id="delete-form-{{$task->id}}" action="{{ route('usertask.destroy', ['id' => $task->id]) }}" method="post" style="display: none;">
    @csrf
    @method('DELETE')
</form>
@endif
